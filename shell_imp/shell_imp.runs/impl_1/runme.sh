...
HD_PWD='/home/rootie/Documents/comp-arc/shell_imp/shell_imp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_wrapper.vdi -applog -m64 -tempDir /home/rootie/.vivado -product Vivado -messageDb vivado.pb -mode batch -source design_1_wrapper.tcl -notrace
