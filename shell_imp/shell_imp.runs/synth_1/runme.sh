...
HD_PWD='/home/rootie/Documents/comp-arc/shell_imp/shell_imp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_wrapper.vds -m64 -tempDir /home/rootie/.vivado -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_wrapper.tcl
