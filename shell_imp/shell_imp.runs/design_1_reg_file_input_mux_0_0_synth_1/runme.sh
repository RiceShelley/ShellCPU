...
HD_PWD='/home/rootie/Documents/comp-arc/shell_imp/shell_imp.runs/design_1_reg_file_input_mux_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_reg_file_input_mux_0_0.vds -m64 -tempDir /home/rootie/.vivado -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_reg_file_input_mux_0_0.tcl
