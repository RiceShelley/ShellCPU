...
#set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { flag }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
##Pmod Header JD
#set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { debug_out }]; #IO_L21N_T3_DQS_35 Sch=jd[1]
