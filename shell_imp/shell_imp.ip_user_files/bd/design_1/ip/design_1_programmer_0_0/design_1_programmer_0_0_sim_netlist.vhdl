...
architecture STRUCTURE of design_1_programmer_0_0_programmer is
  ...
  signal \delay_cnt[6]_i_3_n_0\ : STD_LOGIC;
  signal \delay_cnt[6]_i_4_n_0\ : STD_LOGIC;
  signal \delay_cnt[6]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \rx_ready_buff_reg_n_0_[1]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[6]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FSM_onehot_state[6]_i_4\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \delay_cnt[6]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \delay_cnt[6]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \delay_cnt[6]_i_5\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of prog_mem_wr_i_3 : label is "soft_lutpair0";
begin
...
\cmd[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"20"
    )
        port map (
...
\delay_cnt[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4F80"
    )
        port map (
...
\delay_cnt[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\delay_cnt[6]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
...
\delay_cnt[6]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\delay_cnt[6]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
prog_mem_wr_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
